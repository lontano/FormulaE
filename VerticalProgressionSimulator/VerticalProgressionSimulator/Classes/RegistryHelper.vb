...
Public Class RegistryHelper
  ...
  Private sRegRootPath As String        'Path Origen del registre (per defecte Software\Al-Kamel\)
  Private nPiNumConfig As Integer       'Número de configuració
  Private sPiPrefixConfig As String      'normalment "Config"
  Public Sub New(Optional ByVal sRegRootPath As String = "Software\Al-Kamel\")
    ' Inicialitza el paths on anira a buscar o desar la configuracio.   
    Me.sRegRootPath = sRegRootPath
  ...
  End Sub
  Public Sub New(ByVal siNomAplicacio As String, ByVal siPrefixConfig As String, ByVal niNumConfig As Integer, Optional ByVal sRegRootPath As String = "Software\Al-Kamel\")
    Me.sRegRootPath = sRegRootPath
  ...
  Property PrefixConfig() As String
    ...
    End Set
  End Property
  Public Sub WriteSubKeyValue(ByVal siSubKey As String, ByVal siClau As String, ByVal viValor As Object, ByVal eiBranca As eBrancaReg,
    ...
    If biXifrat Then 'Encriptem Valor
      vValor = Encode(CStr(viValor), UCase$(Trim$(siClau)))
    Else
      vValor = viValor
    End If
    ...
    Clau = Nothing
  End Sub
  Public Sub WriteValue(ByVal siClau As String, ByVal viValor As Object, ByVal eiBranca As eBrancaReg,
    ByVal eiTipusReg As RegistryValueKind, ByVal biXifrat As Boolean)
    WriteSubKeyValue("", siClau, viValor, eiBranca, eiTipusReg, biXifrat)
  End Sub
  Public Function ReadSubKeyValue(ByVal siSubKey As String, ByVal siValue As String, ByVal viDefault As Object, ByVal eBranca As eBrancaReg,
    ...
    If Not Clau Is Nothing Then
      ...
      Else
        If biXifrat Then
          vValor = Decode(CStr(vValor), UCase$(Trim$(siValue)))
        End If
      End If
      Return vValor
    Else
    ...
    End If
  End Function
  Public Function ReadValue(ByVal siClau As String, ByVal viDefault As Object, ByVal eBranca As eBrancaReg,
    ByVal biXifrat As Boolean) As Object
  ...
  Private Function GetRootKey(ByVal eiBranca As eBrancaReg, ByVal siSubKey As String, ByVal biWritable As Boolean, ByVal biCreate As Boolean) As RegistryKey
    ...
    sKey = Concat(sRegRootPath, "\", sPiNomAplicacio)
    ...
    RegKey = Nothing
  End Function
  Private Function Concat(ByVal si1 As String, ByVal siSep As String,
  ...
  Public Function GetSubKeyKeyNames(ByVal siKey As String, ByVal eiBranca As eBrancaReg) As String()
    ...
    Return sSubKeyNames
  End Function
  Private Function Encode(ByVal siStr As String,
    ...
    Encode = sOut
  End Function
  Private Function Decode(ByVal siStr As String, Optional ByVal siClau As String = "") As String
    Dim nNum As Integer
    Dim nLast As Integer
    Dim sClau As String
    Dim sStr As String = ""
